...
${out.bold('Other options:')}
  ...
  --destroy                    Also terminate workflows, scoped to the resolved ensemble (down only)
  --all-ensembles              Widen --destroy to EVERY ensemble + the global maestro (down --destroy, #907)
  ...
  --ensemble <name>            Target a specific ensemble (broadcast, destroy, restore, down --destroy)
