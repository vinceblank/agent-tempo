...
<!-- DRAFT for 1.7.0 — finalizes the 1.7.0 line (beta.0 → beta.8 → stable). Version header and date left blank for operator cut. #811 (pid-file fix) not yet created — add when it lands. -->
