...
function DCFocusOverlay({ entry, sectionMeta, sectionOrder }) {
  ...
  const scale = Math.max(0.1, Math.min((vp.w - 96) / width, (vp.h - 160) / height, 2));
  ...
  return ReactDOM.createPortal(
    <div onClick={() => ctx.setFocus(null)}
      ...
      <div
        style={{ position: 'absolute', top: 64, bottom: 56, left: 48, right: 48, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 16 }}>
