...
| `WorkflowNotFound` (SDK-native) | Any operation against a pinned runId that doesn't exist | Temporal SDK default | Adapter exits per §9.4. Tools retry once without runId pin; if still fails, surface to user. |
